...
class HashTable:
    ...
    def put(self, key, value):
        ...
        if(self.data[currIndex] == None):
            self.data[currIndex] = HashTableEntry(key, value)
            self.size += 1
        else:
            curr = self.data[currIndex]
            ...
            if curr.key == key:
                ...
                new_entry.next = self.data[currIndex]
                self.data[currIndex] = new_entry
                self.size += 1
    ...
    def delete(self, key):
        ...
        """
        currIndex = self.hash_index(key)
        if self.data[currIndex].key == key:
            if self.data[currIndex].next == None:
                self.data[currIndex] = None
                self.size -= 1
            else:
                new_head = self.data[currIndex].next
                self.data[currIndex].next = None
                self.data[currIndex] = new_head
                self.size -= 1
        else:
            if self.data[currIndex] == None:
                return None
